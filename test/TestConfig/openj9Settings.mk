...
ifneq (, $(findstring current, $(JCL_VERSION)))
	ifneq (,$(findstring win,$(SPEC)))
		...
		JAVA_SHARED_LIBRARIES_DIR:=$(JAVA_BIN)$(D)..$(D)lib$(D)$(ARCH_DIR)$(D)$(VM_SUBDIR)
		J9VM_PATH=$(JAVA_BIN)$(D)..$(D)lib$(D)$(ARCH_DIR)$(D)j9vm
	endif
	ADD_JVM_LIB_DIR_TO_LIBPATH:=export LIBPATH=$(Q)$(LIBPATH)$(P)$(JAVA_BIN)$(D)..$(D)lib$(D)$(VM_SUBDIR)$(P)$(JAVA_SHARED_LIBRARIES_DIR)$(P)$(JAVA_BIN)$(D)j9vm$(Q);
else
